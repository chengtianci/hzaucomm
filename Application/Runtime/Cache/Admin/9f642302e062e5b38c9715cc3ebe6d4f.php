    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <div class="right_col" role="main">
          ...
          <div class="x_panel">
            <div class="x_title">
              <h2>图片上传申请 <small>Picture upload application</small></h2>
                        ...
                        <div class="image view view-first">
                            ...
                            <div class="mask">
                                ...
                                <div class="tools tools-bottom">
                                    <a href="/hzaucomm/index.php/Admin/Source/pictureshow" data-toggle="modal" data-target="#myModal"><i class="fa fa-image"></i></a>
                                    <a href="/hzaucomm/index.php/Admin/Source/imgDelete/id/<?php echo ($vo["id"]); ?>/ty/<?php echo ($vo["type"]); ?>"><i class="fa fa-times"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
