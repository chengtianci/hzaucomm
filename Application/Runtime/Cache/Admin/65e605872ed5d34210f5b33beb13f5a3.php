    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <div class="col-md-10 col-sm-12 col-xs-12" style="width: 100%;">
          <div class="x_panel">
            <div class="x_title">
               <h2>用户管理 <small>Authority Administrate</small></h2>
            ...
            <div class="x_content">
              <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><a href="/hzaucomm/index.php/Admin/User/">$vo.r_name</a></td>
                    <td>$vo.r_time</td>
                    <td>
                      <a href="/hzaucomm/index.php/Admin/User/" >Edit <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a href="/hzaucomm/index.php/Admin/User/" >Delete <i class="fa fa-close"></i></a>
                    </td>
                  </tr>
                ...
                <!-- <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if($k % 2 == 0) { ?>
                  <tr>
                    <td><a href="/hzaucomm/index.php/Admin/User/laboratory_show2_update/id/<?php echo ($vo["id"]); ?>/by/2"><?php echo ($vo["r_name"]); ?></a></td>
                    <td><?php echo ($vo["r_time"]); ?></td>
                    <td>
                      <a href="/hzaucomm/index.php/Admin/User/laboratory_show2_update/id/<?php echo ($vo["id"]); ?>/by/2" >Edit <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a href="/hzaucomm/index.php/Admin/User/laboratory_show1_delete/id/<?php echo ($vo["id"]); ?>/ta/2" >Delete <i class="fa fa-close"></i></a>
                    </td>
                  </tr>
                  <?php } else { ?>
                  <tr>
              ...
              <br><br>
              <div  data-toggle="modal" data-target="#myModal" class="gallery_add">ADD</div>
            </div>
          </div>
      </div>
    </div> 
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <input type="text" class="gallery_title" name="gallery_title" value="<?php echo ($vo["imgname"]); ?>" placeholder="Fill in the title, please">
                      <div class="coninput"><span class="hint">用户名：</span><input type="text" class="text" name="gallery_title" value="<?php echo ($vo["imgname"]); ?>" placeholder=""></div>
                      <div class="gallery_coninput"><span class="gallery_hint">密码：</span><input type="text" class="gallery_text" name="gallery_title" value="<?php echo ($vo["imgname"]); ?>" placeholder=""></div>
                      <div class="gallery_coninput"><span class="gallery_hint">确认密码：</span><input type="text" class="gallery_text" name="gallery_title" value="<?php echo ($vo["imgname"]); ?>" placeholder=""></div>
                    </form>
