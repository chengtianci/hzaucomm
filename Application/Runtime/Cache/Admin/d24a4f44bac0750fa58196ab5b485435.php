...
<head>
    ...
    <!-- to DO list的对勾 -->
    <link href="/hzaucomm/Public/back/include/iCheck/skins/flat/green.css" rel="stylesheet">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <div class="col-md-12 col-sm-6 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>联系我们 <small>Connect</small></h2>
              ...
              <div class="x_content">
                  ...
                  <input type="text" id="idInfor" value="<?php echo ($data["id"]); ?>" hidden>
                     <script id='container' style="height:350px;" name='content' type="text/plain">这里写联系方式</script>
