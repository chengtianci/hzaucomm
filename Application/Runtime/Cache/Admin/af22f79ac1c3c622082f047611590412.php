  ...
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      ...
      <li><a><i class="fa fa-user"></i>用户管理<span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a href="/hzaucomm/index.php/Admin/">管理</a></li>
          <li><a href="/hzaucomm/index.php/Admin/">权限设置</a></li>
        </ul>
      </li>
    </ul>
  </div>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="">
          <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
            <img src="/hzaucomm/Public/back/images/img.jpg" alt="">Mr.Tian
              ...
              <div class="x_content">
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Comp/commentshow">r_name</a></td>
                      <td>r_time</td>
                      <td>
