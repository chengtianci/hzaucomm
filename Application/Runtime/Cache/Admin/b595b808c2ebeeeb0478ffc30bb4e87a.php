      ...
      <div class="modal-footer">
		...
		<div class="right_col" role="main">
                  ...
                  <div class="x_content">
                    ...
                    <div class="row">
                            <div class="col-md-55">
                                <div class="thumbnail">
                                    <div class="image view view-first">
                                        <img style="width: 100%;height: 100%; display: block;" src="/hzaucomm/Public/face/images/slider/lrgimg4.jpg" alt="image" />
                                        <div class="mask">
                                            <p>实践学习类</p>
                                            <div class="tools tools-bottom">
                                                <a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil"></i></a>
                                                <a href="/hzaucomm/index.php/Admin/Index/imgDelete/id/<?php echo ($vo["id"]); ?>/ty/<?php echo ($vo["type"]); ?>"><i class="fa fa-times"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-55">
                                <div class="thumbnail">
                                    <div class="image view view-first">
                                        <img style="width: 100%;height: 100%; display: block;" src="/hzaucomm/Public/face/images/slider/lrgimg5.jpg" alt="image" />
                                        <div class="mask">
                                            <p>专业基础类</p>
                                            <div class="tools tools-bottom">
                                                <a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil"></i></a>
                                ...
                                <div class="thumbnail">
                                    <div class="image view view-first">
                                        <img style="width: 100%;height: 100%; display: block;" src="/hzaucomm/Public/face/images/slider/lrgimg2.jpg" alt="image" />
                                        <div class="mask">
                                            <p>作物生产类</p>
                                            <div class="tools tools-bottom">
                                                <a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil"></i></a>
                                ...
                                <div class="thumbnail">
                                    <div class="image view view-first">
                                        <img style="width: 100%;height: 100%; display: block;" src="/hzaucomm/Public/face/images/slider/lrgimg6.jpg" alt="image" />
                                        <div class="mask">
                                            <p>植物保护类</p>
                                            <div class="tools tools-bottom">
                                                <a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil"></i></a>
          ...
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>热门主题 <small>Hot Topic</small></h2>
                <ul class="nav navbar-right panel_toolbox">
              ...
              <div class="x_content">
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Index/">r_name</a></td>
                      <td>r_time</td>
                      <td>
                        
                        <a href="/hzaucomm/index.php/Admin/Index/" >Delete <i class="fa fa-close"></i></a>
                      </td>
                    </tr>
                  ...
                  <!-- <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if($k % 2 == 0) { ?>
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Index/fictitious_show1_update/id/<?php echo ($vo["id"]); ?>/by/1"><?php echo ($vo["r_name"]); ?></a></td>
                      <td><?php echo ($vo["r_time"]); ?></td>
                      <td>
                        
                        <a href="/hzaucomm/index.php/Admin/Index/creation_show1_delete/id/<?php echo ($vo["id"]); ?>/ta/1" >Delete <i class="fa fa-close"></i></a>
                      </td>
                    </tr>
                    <?php } else { ?>
                    <tr>
          ...
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>最新交流 <small>Latest Topic</small></h2>
                <ul class="nav navbar-right panel_toolbox">
                  <li class="panel_toolbox_li"><a class="close-link"><i class="fa fa-close"></i></a>
                  </li>
                  <li class="panel_toolbox_li"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <form class="form" action="" method="post">
                      ...
                      <script id='container' name='content' type="text/plain"><?php echo ($vo["imgintro"]); ?></script>
                      <!--配置文件-->
