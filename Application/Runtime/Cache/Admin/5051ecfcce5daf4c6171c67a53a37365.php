      ...
      <div class="modal-footer">
        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>其他上传申请<small>Other upload application</small></h2>
              ...
              <div class="x_content">
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Source/">r_name</a></td>
                      <td>r_time</td>
                      <td>
                        <a href="/hzaucomm/index.php/Admin/Source/" >Edit <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/hzaucomm/index.php/Admin/Source/" >Delete <i class="fa fa-close"></i></a>
                      </td>
                    </tr>
                  ...
                  <!-- <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if($k % 2 == 0) { ?>
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Source/fictitious_show1_update/id/<?php echo ($vo["id"]); ?>/by/1"><?php echo ($vo["r_name"]); ?></a></td>
                      <td><?php echo ($vo["r_time"]); ?></td>
                      <td>
                        <a href="/hzaucomm/index.php/Admin/Source/fictitious_show1_update/id/<?php echo ($vo["id"]); ?>/by/1" >Edit <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/hzaucomm/index.php/Admin/Source/creation_show1_delete/id/<?php echo ($vo["id"]); ?>/ta/1" >Delete <i class="fa fa-close"></i></a>
                      </td>
                    </tr>
                    <?php } else { ?>
                    <tr>
