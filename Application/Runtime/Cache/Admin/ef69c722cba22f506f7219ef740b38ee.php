      ...
      <div class="modal-footer">
		...
		<div class="right_col" role="main">
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>主题交流 <small>Archive</small></h2>
              ...
              <div class="x_content">
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Course/themeshow">r_name</a></td>
                      <td>r_time</td>
                      <td>
                        <a href="/hzaucomm/index.php/Admin/Course/" >Delete <i class="fa fa-close"></i></a>
                      </td>
                    </tr>
                  ...
                  <!-- <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if($k % 2 == 0) { ?>
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Course/fictitious_show1_update/id/<?php echo ($vo["id"]); ?>/by/1"><?php echo ($vo["r_name"]); ?></a></td>
                      <td><?php echo ($vo["r_time"]); ?></td>
                      <td>
                        <a href="/hzaucomm/index.php/Admin/Course/fictitious_show1_update/id/<?php echo ($vo["id"]); ?>/by/1" >Edit <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/hzaucomm/index.php/Admin/Course/creation_show1_delete/id/<?php echo ($vo["id"]); ?>/ta/1" >Delete <i class="fa fa-close"></i></a>
                      </td>
                    </tr>
                    <?php } else { ?>
                    <tr>
          ...
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>主题申请 <small>Archive</small></h2>
                <ul class="nav navbar-right panel_toolbox">
                  <li class="panel_toolbox_li"><a class="close-link"><i class="fa fa-close"></i></a>
                  </li>
                  <li class="panel_toolbox_li"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
              ...
              <div class="x_content">
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Course/themeread">r_name</a></td>
                      <td>r_time</td>
                      <td>
                        <a href="/hzaucomm/index.php/Admin/Course/" >Reject <i class="fa fa-close"></i></a>
                      </td>
                    </tr>
                  ...
                  <!-- <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if($k % 2 == 0) { ?>
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Course/themeread"><?php echo ($vo["r_name"]); ?></a></td>
                      <td><?php echo ($vo["r_time"]); ?></td>
                      <td>
                        <a href="/hzaucomm/index.php/Admin/Course/creation_show1_delete/id/<?php echo ($vo["id"]); ?>/ta/1" >Reject <i class="fa fa-close"></i></a>
                      </td>
                    </tr>
                    <?php } else { ?>
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Course/themeread</a></td>
                      <td><?php echo ($vo["r_time"]); ?></td>
                      <td>
                      <a href="/hzaucomm/index.php/Admin/Course/creation_show1_delete/id/<?php echo ($vo["id"]); ?>/ta/1" >Reject <i class="fa fa-close"></i></a>
                      </td>
          ...
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>回复申请 <small>Archive</small></h2>
                <ul class="nav navbar-right panel_toolbox">
                  <li class="panel_toolbox_li"><a class="close-link"><i class="fa fa-close"></i></a>
                  </li>
                  <li class="panel_toolbox_li"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
              ...
              <div class="x_content">
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Course/commentread">r_name</a></td>
                      <td>r_time</td>
                      <td>
                        <a href="/hzaucomm/index.php/Admin/Course/" >Reject <i class="fa fa-close"></i></a>
                      </td>
                  ...
                  <!-- <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if($k % 2 == 0) { ?>
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Course/commentread</a></td>
                      <td><?php echo ($vo["r_time"]); ?></td>
                      <td>
                        <a href="/hzaucomm/index.php/Admin/Course/creation_show1_delete/id/<?php echo ($vo["id"]); ?>/ta/1" >Reject <i class="fa fa-close"></i></a>
                      </td>
                ...
                <script type="text/javascript">
                    $(function () {
                        ...
                        $('#saveContent').click(function () {
                            ...
                            $.ajax({
                                url: '/hzaucomm/index.php/Admin/Course/subInfor/at/15',
                                type: 'POST',
                                dataType: 'json',
                                data: param,
                                success: function(data){
                                    console.log(data);
                                    window.location.href="/hzaucomm/index.php/Admin/Course/fictitious_show1";
                                },
                                error: function(xhr){
                                    alert("添加失败");
                                    console.log(xhr);
