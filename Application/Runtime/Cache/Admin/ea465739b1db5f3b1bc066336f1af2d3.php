              ...
              <div class="x_content">
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Source/documentshow">r_name</a></td>
                      <td>r_time</td>
                      <td>
                  ...
                  <!-- <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if($k % 2 == 0) { ?>
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Source/documentshow</a></td>
                    ...
                    <?php } else { ?>
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Source/documentshow</td>
                      <td><?php echo ($vo["r_time"]); ?></td>
                      <td>
                       <a href="/hzaucomm/index.php/Admin/Source/creation_show1_delete/id/<?php echo ($vo["id"]); ?>/ta/1" >Delete <i class="fa fa-close"></i></a>
                      </td>
