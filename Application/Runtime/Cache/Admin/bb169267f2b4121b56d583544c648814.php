...
<div class="right_col" role="main">
          ...
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>视频上传申请 <small>Documents upload application</small></h2>
              ...
              <div class="x_content">
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <!-- <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if($k % 2 == 0) { ?>
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Source/</a></td>
                    ...
                    <?php } else { ?>
                    <tr>
                      <td><a href="/hzaucomm/index.php/Admin/Source/</td>
                      <td><?php echo ($vo["r_time"]); ?></td>
                      <td>
                        <a href="/hzaucomm/index.php/Admin/Source/creation_show1_delete/id/<?php echo ($vo["id"]); ?>/ta/1" >Delete <i class="fa fa-close"></i></a>
                      </td>
                ...
                <script type="text/javascript">
                    $(function () {
                        ...
                        $('#saveContent').click(function () {
                            ...
                            $.ajax({
                                url: '/hzaucomm/index.php/Admin/Source/subInfor/at/15',
                                type: 'POST',
                                dataType: 'json',
                                data: param,
                                success: function(data){
                                    console.log(data);
                                    window.location.href="/hzaucomm/index.php/Admin/Source/fictitious_show1";
                                },
                                error: function(xhr){
                                    alert("添加失败");
                                    console.log(xhr);
