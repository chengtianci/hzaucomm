...
<head>
	...
	<link rel="stylesheet" href="/hzaucomm/Public/face/css/picture.css"/>
	...
	<div id="Cmain">
		<div class="Ccontainer">
			...
			<div class="rightc_nhot">
				<div class="mini_nav">
					<span class="mini_title">图片</span>
				</div>
				<div class="search_Button">
					<form class="searchform" action="" method="post">
						<div class="con_input"><input class='input' type="text" name="search"><input id="Ssubmit" type="submit" value="图片搜索" ></div><div class="clr"></div>
					</form>
				</div>
				<div class="picturecon">
					<div class="ex_pic">
						<a href="/hzaucomm/index.php/Home/source/pictureshow"><img class="picture" src="/hzaucomm/Public/face/images/slider/lrgimg4.jpg"></a>
						<div class="cont">
						<span class="descri">miaoshuxingyuyan</span><br>
