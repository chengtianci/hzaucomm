	...
	<div id="Cmain">
		<div class="Ccontainer">
			...
			<div class="rightc_nhot">
				<div class="mini_nav">
					<span class="mini_title">图片上传</span>
				</div>
				<form id='myform' action="" enctype="multipart/form-data" method="post"  >
	                <div class="con_input"><sapn class="hint">图片标题：</sapn><input class='input' type="text" name="title"></div><div class="clr"></div>
					<div class="con_input"><sapn class="hint">图片描述：</sapn><textarea class='textinput' type="text" name="descripe"></textarea></div><div class="clr"></div>
					<div class="con_input"><span class="hint">选择图片</span><input class='inputfile' type="file" name="photo"></div><div class="clr"></div>
