		...
		<div class="Ccontainer">
			<div id="main_nav">
				<section>
					<h3>平台简介</h3>
					<ul class="ultop">
						<li><a href="/hzaucomm/index.php/Home/introduction/introduction.html">平台简介</a></li>
						<li><a href="/hzaucomm/index.php/Home/introduction/notice.html">通知公告</a></li>
					</ul>
				</section>
			</div>
			<div class="rightc">
				<div class="mini_nav">
					<span class="mini_title">公告名</span>
				</div>
				<div class="summary">
					<p class="con">
