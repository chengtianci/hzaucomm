  ...
  <div id="header_right">
    ...
    <div id="nav">
        <ul id="nav_mul">
            ...
            <li class="nav_first">
                <a id="nav_main" href="/hzaucomm/index.php/Home/index/introduction.html">平台简介</a>
            </li>
            <li class="nav_first">
                <a id="nav_course" href="/hzaucomm/index.php/Home/index/course.html">学科交流平台</a>
                <div id="nav_hidden">
                <ul >
                    <li><a href="/hzaucomm/index.php/Home/index/course.html?">course one</a></li>
                    <li><a href="/hzaucomm/index.php/Home/index/course.html?">course two</a></li>
                    <li><a href="/hzaucomm/index.php/Home/index/course.html?">course three</a></li>
                </ul>
                </div>
            </li>
            <li class="nav_first">
                <a id="nav_source" href="/hzaucomm/index.php/Home/index/source.html">资源共享平台</a>
                <div id="nav_hidden">
                <ul >
                    <li><a href="">picture</a></li>
                    <li><a href="/hzaucomm/index.php/Home/index/document.html">document</a></li>
            ...
            <li class="nav_first">
               <a id="nav_comp" id="nav_comp" href="/hzaucomm/index.php/Home/index/comp.html">综合交流平台</a>
            </li>
            <li class="nav_first">
                <a id="nav_main" href="/hzaucomm/index.php/Home/index/about.html">关于我们</a>
            </li>             
        </ul>
    </div>
</div>
					...
					<div class="topic">
						...
						<div class="substance">
							<div class="substance_top">
								<div class="s_t_title"><a href="/hzaucomm/index.php/Home/index/showitem.html">讨论交流主题 arghikashu a wkdfihaiuwh awrhauiwrh arsetgsedwgsdaergasetgwAETSERFErfsgsd的责任感的大概多少如果这些gfhuiawgb rfu</a></div>
								<div class="s_t_author"><img src="" alt="" class="icon_a" title="主题作者：" style="background: url(/hzaucomm/Public/face/images/icon.png) no-repeat;">
								<div class="change"><span class="s_t_l">发布者</span>
								<div class="s_t_a_hid">发布者信息方式各一个分阿斯乌尔禾ifuse覆盖哈胡一菲桂柳话 UI规划局看都看好陆毅老客户了耦合剂 </div>
								</div>
								</div>
							</div>
							<div class="clr"></div>
							<div class="substance_down">
								<div class="s_d_reply">ahwui金海威风阿尔回复一句话吧而非爱上合计发红包按碎回复哈斯uebfuiasiefjhuasihef家色符合最新的回复信息</div>
								<div class="s_d_author"><img src="" alt="" class="icon_r" title="最新回复人：" style="background: url(/hzaucomm/Public/face/images/icon.png) no-repeat;">
									<div class="change">
										<span class="s_d_l">回复人</span>
										<span  class="s_d_r_time" title="最后回复时间">00:00</span>
										<div class="s_d_a_hid">
