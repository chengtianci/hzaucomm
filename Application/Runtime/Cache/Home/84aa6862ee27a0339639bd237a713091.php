...
<head>
	...
	<link rel="stylesheet" href="/hzaucomm/Public/face/css/introduction.css"/>
	...
	<div id="Cmain">
		<div class="Ccontainer">
			...
			<div class="rightc_nhot">
				<div class="mini_nav">
					<span class="mini_title">平台概况</span>
				</div>
				<div class="intro_contant">
					<p class="intro_contant_mess">
						实验教学中心互动平台实验教学中心互动平台实验教学中心互动平台实验教学中心互动平台实验教学中心互动平台实验教学中心互动平台实验教学中心互动平台
						实验教学中心互动平台实验教学中心互动平台实验教学中心互动平台实验教学中心互动平台实验教学中心互动平台实验教学中心互动平台实验教学中心互动平台
					</p>
				</div>
			</div>
