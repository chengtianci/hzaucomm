...
<head>
	...
	<link rel="stylesheet" href="/hzaucomm/Public/face/css/document.css"/>
	...
	<div id="Cmain">
		<div class="Ccontainer">
			...
			<div class="rightc_nhot">
				<div class="mini_nav">
					<span class="mini_title">其他</span>
				</div>
				<div class="search_Button">
					<form class="searchform" action="" method="post">
						<div class="con_input"><input class='input' type="text" name="search"><input id="Ssubmit" type="submit" value="其他搜索" ></div><div class="clr"></div>
					</form>
				</div>
				<div class="float_lis">
					<div class="list">
						<ul>
							<li ><a class="ex_item" href="/hzaucomm/index.php/Home/source/summary"><div class="point"></div><p>实验教学中心互动平台</p><span>2017-05-06</span></a></li>
							<li ><a class="ex_item" href="/hzaucomm/index.php/Home/source/summary"><div class="point"></div><p>实验教学中心互动平台</p><span>2017-05-06</span></a></li>
							<li ><a class="ex_item" href="/hzaucomm/index.php/Home/source/summary"><div class="point"></div><p>实验教学中心互动平台</p><span>2017-05-06</span></a></li>
							<li ><a class="ex_item" href="/hzaucomm/index.php/Home/source/summary"><div class="point"></div><p>实验教学中心互动平台</p><span>2017-05-06</span></a></li>
						</ul>
