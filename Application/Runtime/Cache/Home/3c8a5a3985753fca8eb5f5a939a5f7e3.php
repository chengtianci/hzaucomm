	...
	<div id="Cmain">
		<div class="Ccontainer">
			...
			<div class="rightc_nhot">
				<div class="mini_nav">
					<span class="mini_title">其他上传</span>
				</div>
				<form id='myform' action="" enctype="multipart/form-data" method="post"  >
	                <div class="con_input"><sapn class="hint">标题：</sapn><input class='input' type="text" name="title"></div><div class="clr"></div>
					<div class="con_input"><sapn class="hint">描述：</sapn><textarea class='textinput' type="text" name="descripe"></textarea></div><div class="clr"></div>
					<div class="con_input"><span class="hint">选择路径</span><input class='inputfile' type="file" name="zip"></div><div class="clr"></div>
