	...
	<div id="Cmain">
		<div class="Ccontainer">
			...
			<div class="rightc_nhot">
				<div class="mini_nav">
					<span class="mini_title">文件</span>
				</div>
				<div class="search_Button">
					<form class="searchform" action="" method="post">
						<div class="con_input"><input class='input' type="text" name="search"><input id="Ssubmit" type="submit" value="文件搜索" ></div><div class="clr"></div>
					</form>
				</div>
				<div class="float_lis">
					<div class="list">
